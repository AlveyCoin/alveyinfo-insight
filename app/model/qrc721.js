module.exports = app => {
  ...
  ARC721.associate = () => {
    ...
    ReceiptLog.belongsTo(ARC721, {as: 'arc721', foreignKey: 'address', sourceKey: 'contractAddress'})
    ARC721.hasOne(ReceiptLog, {as: 'eventLogs', foreignKey: 'address', sourceKey: 'contractAddress'})
