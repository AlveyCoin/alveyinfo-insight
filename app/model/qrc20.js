module.exports = app => {
  ...
  ARC20.associate = () => {
    ...
    ReceiptLog.belongsTo(ARC20, {as: 'arc20', foreignKey: 'address', sourceKey: 'contractAddress'})
    ARC20.hasMany(ReceiptLog, {as: 'eventLogs', foreignKey: 'address', sourceKey: 'contractAddress'})
