module.exports = app => {
  ...
  router.get(
    '/contract/:contract/arc20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.arc20BalanceHistory
  )
  router.get(
    '/searchlogs',
  ...
  router.get(
    '/arc20',
    paginationMiddleware,
    controller.arc20.list
  )
  router.get(
    '/arc20/:contract/rich-list',
    contractMiddleware, paginationMiddleware,
    controller.arc20.richList
  )
  router.get(
    '/arc721',
    paginationMiddleware,
    controller.arc721.list
  )
}
